...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <div>
        <form
          action="https://formsubmit.co/contact@mustanggg.com"
          method="post"
        >
          <input
            type="text"
          ...
          <input
            type="submit"
            value="Subscribe"
            className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm  bg-[#a01833] px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-[#000] dark:shadow-submit-dark"
          />
        </form>
