...
const featuresData: Feature[] = [
  ...
  },
  {
    ...
    title: "Investigation",
    paragraph:
      "In the battle against cybercrime, our intelligence-driven approach navigates scams, fraud, and cryptocurrency threats globally.From hacking incidents to major Bitcoin thefts, our commitment extends to victims worldwide. Collaborating with exchanges and law enforcement, we provide actionable intelligence, securing the digital realm with unwavering dedication.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "In the pursuit of assets recovery, our dedicated efforts form a robust front against cybercrime. Leveraging expertise in tracking and uncovering cryptocurrency trails, we meticulously trace stolen assets from internet scams, investment fraud, and cryptocurrency schemes.Collaborating globally with exchanges, law enforcement, and regulators, our focus is not only on recovery but also on dismantling criminal networks. Our commitment extends to victims worldwide, offering a beacon of support and expertise in the relentless pursuit of reclaiming what is rightfully theirs.",
  },
];
